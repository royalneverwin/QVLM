...
def eval_model(args):
    ...
    # Check if answers file exists and load existing answers
        ...
        with open(answers_file, "r") as f:
            for line in f:
                try:
                    ...
                    existing_question_ids.add(data["question_id"])
                except json.JSONDecodeError:
                    continue
        ans_file = open(answers_file, "a") # Open in append mode
    else:
        # If answers file does not exist, raise an error as requested
