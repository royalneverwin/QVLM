...
ALPHA=0.3
VISUAL_TOKEN_NUM=32
QUANT_METHOD="complex" # l2_norm l1_norm l_inf variance l2 quant_error quant_error_clip quant_error_group dynamic_range complex complex_l1 complex_mul
for IDX in $(seq 0 $((CHUNKS-1))); do
    ...
    --answers-file /mnt/bn/yufei1900/wangxinhao/paper/QVLM_2/results/4_Bit_${VISUAL_TOKEN_NUM}_tokens_withquant_alpha_${ALPHA}_method_${QUANT_METHOD}/LLaVA-vicuna-7B-v1.3-4bit-chunk$CHUNKS_$IDX.jsonl \
    --num-chunks $CHUNKS \
    --chunk-idx $IDX \
    --load-4bit \
