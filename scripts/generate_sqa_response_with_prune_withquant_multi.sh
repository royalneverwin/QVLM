...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=$((IDX+0)) python -m llava.eval.model_vqa_science_add \
    ...
    --answers-file /mnt/bn/yufei1900/wangxinhao/paper/QVLM_2/results/4_Bit_${VISUAL_TOKEN_NUM}_tokens_withquant_alpha_${ALPHA}_method_${QUANT_METHOD}_${PRUNING_METHOD}_try2/LLaVA-vicuna-7B-v1.3-4bit-chunk$CHUNKS_$IDX.jsonl \
    --num-chunks $CHUNKS \
    --chunk-idx $IDX \
    --load-4bit \
