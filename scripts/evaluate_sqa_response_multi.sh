...
CHUNKS=8
result_path="/mnt/bn/yufei1900/wangxinhao/paper/QVLM_2/results/4_Bit_32_tokens_withquant_alpha_0.5_method_quant_error_group_visionzip"
...
CUDA_VISIBLE_DEVICES=7 python llava/eval/eval_science_qa.py \
    --base-dir /mnt/bn/yufei1900/wangxinhao/paper/ScienceQA/data/scienceqa \
